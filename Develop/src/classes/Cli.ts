  ...
  performActions(): void {
    inquirer
      .prompt([
        {
          ...
          choices: [
            ...
            'Tow another vehicle (Truck)',
            'Do a wheelie (Motorbike)',
            'Exit',
          ],
        },
      ])
      .then((answers) => {
        ...
        else if (answers.action === 'Tow another vehicle (Truck)') {
        ...
        else if (answers.action === 'Do a wheelie (Motorbike)') {
